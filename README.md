...
## Brand Focus
I build practical software leverage for founders and operators:
- Workflow automation that removes repetitive work
- AI-native products with real utility
- Production-ready web apps shipped fast

## Tech Stack
- Frontend: Next.js, React, TypeScript, Tailwind CSS
- Backend: Node.js, APIs, auth/session systems, integrations
- Automation: OpenClaw workflows, scheduled jobs, orchestration
- Deployment: Vercel + GitHub-based delivery
